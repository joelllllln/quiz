...
(function () {
  window.ORDERS = [
    { key: 'found', title: 'The supervised learning workflow', steps: [
    ...
    { key: 'found', title: 'Diagnosing overfitting', steps: [
    ...
    { key: 'kmeans', title: 'One K-Means run', steps: [
    ...
    { key: 'knn', title: 'Classifying one point with k-NN', steps: [
    ...
    { key: 'trees', title: 'Growing a decision tree', steps: [
    ...
    { key: 'gboost', title: 'One gradient boosting round', steps: [
    ...
    { key: 'rf', title: 'Building a random forest', steps: [
    ...
    { key: 'pca', title: 'Running PCA properly', steps: [
    ...
    { key: 'msel', title: 'Honest model selection', steps: [
    ...
    { key: 'metrics', title: 'From confusion matrix to F1', steps: [
    ...
    { key: 'dbscan', title: 'How DBSCAN labels points', steps: [
    ...
    { key: 'feng', title: 'A leak-free preprocessing pipeline', steps: [
