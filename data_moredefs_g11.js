...
(function () {
  ...
  def("found1",
    ...
    "The full map of values to probabilities; a PMF gives point probabilities for discrete values, a PDF gives density for continuous ones.",
    ["A PMF describes the training data while a PDF describes the test data.",
     "A PMF is the empirical histogram and a PDF is its theoretical prediction.",
     "They are identical except that a PDF is always symmetric around zero.",
     "A distribution is the sorted list of all values a dataset actually contains."],
  ...
  def("pca1",
    ...
    ["The subset of training rows from which all other rows can be reconstructed.",
     "The origin point from which all vectors in the space are measured.",
     "The largest vector in a dataset, against which others are normalised.",
     "A fixed scale that converts all features into the same physical units."],
