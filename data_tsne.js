...
(window.QUESTIONS = window.QUESTIONS || {}).tsne1 = [
  {
    ...
    "choices": [
      ...
      "The variance of every axis",
      "The original coordinates",
      "Cluster sizes and spacings"
    ],
  ...
  },
  {
    ...
    "choices": [
      ...
      "Makes the plot perfectly accurate",
      "Deletes outliers",
  ...
  },
  {
    ...
    "choices": [
      ...
      "A has twice B's variance",
      "C is the most different group",
      "The axes are the top two components",
      "Everything the map shows, exactly"
    ],
  ...
  },
  {
    ...
    "choices": [
      ...
      "t-SNE features are too accurate",
      "PCA is nonlinear and richer",
      "t-SNE only outputs images",
      "Downstream models refuse 2-D inputs"
    ],
