...
(function () {
  ...
  T.push(
    ...
    { key: 'kfold', group: '31 · The core modelling workflow', title: 'K-fold, made explicit',
    ...
    { key: 'skfold', group: '31 · The core modelling workflow', title: 'Stratified k-fold',
    ...
    { key: 'groupkfold', group: '31 · The core modelling workflow', title: 'Group k-fold',
    ...
    { key: 'cvmulti', group: '34 · Evaluating', title: 'Cross-validate several metrics at once',
    ...
    { key: 'rocauc', group: '34 · Evaluating', title: 'ROC curve and AUC',
    ...
    { key: 'prf', group: '34 · Evaluating', title: 'Precision, recall and F1, directly',
    ...
    { key: 'regmetrics', group: '34 · Evaluating', title: 'Regression metrics: MAE, RMSE, R²',
    ...
    { key: 'logloss', group: '34 · Evaluating', title: 'Log loss and the Brier score',
    ...
    { key: 'valcurve', group: '33 · Tuning', title: 'Validation curve over a hyperparameter',
    ...
    { key: 'baseline', group: '34 · Evaluating', title: 'Beat the baseline first',
