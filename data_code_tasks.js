...
(function () {
  window.CODETASKS = [
    ...
    { key: 'split', group: '31 · The core modelling workflow', title: 'Train/test split',
    ...
    { key: 'scale', group: '31 · The core modelling workflow', title: 'Scale features (fit on train only)',
    ...
    { key: 'knn', group: '32 · Fitting models', title: 'Train and use a KNN classifier',
    ...
    { key: 'cv', group: '31 · The core modelling workflow', title: 'Cross-validation',
    ...
    { key: 'pipeline', group: '31 · The core modelling workflow', title: 'Build a Pipeline',
    ...
    { key: 'grid', group: '33 · Tuning', title: 'Grid search with cross-validation',
    ...
    { key: 'logreg', group: '32 · Fitting models', title: 'Logistic regression with probabilities',
    ...
    { key: 'metrics', group: '34 · Evaluating', title: 'Confusion matrix & report',
    ...
    { key: 'rf', group: '32 · Fitting models', title: 'Random forest + feature importances',
    ...
    { key: 'encode', group: '30 · Getting data ready for a model', title: 'Encode categoricals safely',
    ...
    { key: 'kmeans', group: '35 · Unsupervised', title: 'K-means clustering',
    ...
    { key: 'pca', group: '35 · Unsupervised', title: 'PCA transform',
    ...
    { key: 'full', group: '37 · A whole project', title: 'The full workflow, end to end',
