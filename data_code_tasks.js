...
(function () {
  window.CODETASKS = [
    ...
    { key: 'split', group: '35 · The core modelling workflow', title: 'Train/test split',
    ...
    { key: 'scale', group: '35 · The core modelling workflow', title: 'Scale features (fit on train only)',
    ...
    { key: 'knn', group: '36 · Fitting models', title: 'Train and use a KNN classifier',
    ...
    { key: 'cv', group: '35 · The core modelling workflow', title: 'Cross-validation',
    ...
    { key: 'pipeline', group: '35 · The core modelling workflow', title: 'Build a Pipeline',
    ...
    { key: 'grid', group: '37 · Tuning', title: 'Grid search with cross-validation',
    ...
    { key: 'logreg', group: '36 · Fitting models', title: 'Logistic regression with probabilities',
    ...
    { key: 'metrics', group: '38 · Evaluating', title: 'Confusion matrix & report',
    ...
    { key: 'rf', group: '36 · Fitting models', title: 'Random forest + feature importances',
    ...
    { key: 'encode', group: '34 · Getting data ready for a model', title: 'Encode categoricals safely',
    ...
    { key: 'kmeans', group: '39 · Unsupervised', title: 'K-means clustering',
    ...
    { key: 'pca', group: '39 · Unsupervised', title: 'PCA transform',
    ...
    { key: 'full', group: '41 · A whole project', title: 'The full workflow, end to end',
