...
(function () {
  ...
  T.push(
    ...
    { key: 'fixnotfit', group: '40 · Fix the bug', title: 'NotFittedError',
    ...
    { key: 'fixstring', group: '40 · Fix the bug', title: "ValueError: could not convert string to float",
    ...
    { key: 'fixshape', group: '40 · Fix the bug', title: 'Inconsistent numbers of samples',
    ...
    { key: 'fixleak', group: '40 · Fix the bug', title: 'The 100% accuracy "bug"',
    ...
    { key: 'fixconverge', group: '40 · Fix the bug', title: 'ConvergenceWarning',
    ...
    { key: 'fixproba', group: '40 · Fix the bug', title: 'AUC of exactly 0.5 (or a proba crash)',
