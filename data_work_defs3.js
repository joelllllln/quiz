...
(function () {
  ...
  def("wai", 1,
    ...
    "A learned list of numbers representing a text or item, where similar meanings land close together.",
    ["The process of inserting a chatbot widget into a company's existing customer website.",
     "A compressed copy of a document stored inside the model's weights during training.",
  ...
  def("wai", 2,
    ...
    "A store built to search embeddings by similarity — the retrieval engine behind most RAG systems.",
    ["A spreadsheet application optimised for very wide tables with many numeric columns.",
     ...
     "Any database that runs on GPU hardware rather than conventional CPUs."],
    "Vector database",
  ...
  def("wai", 1,
    ...
    "An attack that hides instructions in content an AI reads, hijacking it into ignoring its rules.",
  ...
  def("wai", 2,
    ...
    "The technical controls around a model — filters, validators, refusal rules — keeping outputs within bounds.",
  ...
  def("wai", 2,
    "What is agentic AI?",
    "AI that plans and executes multi-step tasks using tools — browsing, running code, calling APIs — not just answering.",
    ["Any AI system that is deployed by an agency rather than by the firm using it.",
     ...
     "A chatbot that hands difficult conversations over to a human colleague."],
    "Agentic AI",
  ...
  def("wai", 2,
    ...
    "Deliberate adversarial testing — trying to make the system fail, leak, or misbehave before launch.",
  ...
  def("wai", 2,
    "What is MLOps?",
    "The engineering discipline for running ML in production — pipelines, versioning, deployment, monitoring, retraining.",
    ["The military applications division of a machine-learning research laboratory.",
     ...
     "A certification held by engineers who may modify production databases."],
    "MLOps",
  ...
  def("wai", 1,
    ...
    "The structured UK GDPR assessment of privacy risks required before high-risk processing — including much AI.",
  ...
  def("wai", 2,
    ...
    "The regime requiring firms to withstand tech disruption, and giving regulators oversight of vital providers like major clouds.",
    ["A backup power standard that data centres serving the financial industry must meet before hosting critical systems.",
     ...
     "An industry compensation fund that reimburses customers for losses suffered during major technology outages.",
  ...
  def("wai", 2,
    ...
    "Obligations scale with use-case risk: banned practices, strict rules for high-risk uses, lighter duties below.",
  ...
  def("wpay", 1,
    ...
    "The two-factor rule for payments: authentication from two of knowledge, possession and inherence.",
  ...
  def("wpay", 2,
    ...
    "The EU refreshing its payments law — tightening fraud rules, strengthening open banking, merging e-money into the framework.",
  ...
  def("wpay", 1,
    ...
    "Checking payment parties against sanctions lists — like the UK's OFSI list — and freezing hits before funds move.",
    ["Reviewing the film and TV content that payment apps may advertise alongside.",
     ...
     "Testing payment systems under simulated wartime network disruptions.",
  ...
  def("wpay", 1,
    ...
    "Someone who moves criminal money through their own account — recruited knowingly or duped.",
    ["A courier who physically transports cash between the branches of one bank.",
     ...
     "A device that tests stolen cards by making many small online purchases.",
  ...
  def("wpay", 2,
    ...
    "Extending open banking's consent-based data sharing beyond payments to savings, investments, pensions and insurance.",
    ["The publication of every regulated firm's accounts in a public register.",
     ...
     "The conversion of all financial software to open-source licences."],
    "Open finance",
  ...
  def("wpay", 2,
    ...
    "Bank deposits recorded on DLT — still a regulated claim on the bank, unlike a stablecoin's claim on reserves.",
  ...
  def("waws", 2,
    ...
    "The audit log of every API call in the account — who did what, when — where CloudWatch tracks performance.",
    ["The migration service that moves on-premise servers into the AWS cloud.",
     ...
     "A tutorial series that guides new users through the AWS console."],
  ...
  def("waws", 2,
    ...
    "The managed key service: master keys that encrypt the data keys which encrypt your data, with usage logged.",
  ...
  def("waws", 2,
    ...
    "Key-value labels on resources — project, owner, environment — that make bills and audits attributable.",
  ...
  def("waws", 2,
    ...
    "The workflow service that chains AWS steps — Lambdas, jobs, waits, retries — into a visual state machine.",
    ["A fitness-tracking integration for employees of AWS enterprise customers.",
     ...
     "The onboarding checklist new AWS accounts must complete."],
  ...
  def("waws", 1,
    ...
    "Three doors to the same APIs: point-and-click website, terminal commands, and code libraries.",
  ...
  def("waws", 2,
    ...
    "Price tiers trading retrieval speed and cost against storage cost — hot data to deep archive.",
