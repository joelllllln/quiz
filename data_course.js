    ...
    units: [
      ...
      { key: 'py2', name: 'Types, and turning one into another',
        ...
        steps: [
          ...
          { t: 'quiz', title: 'What type is that?', ids: ['pq0-plus-strings', 'pq0-str-int', 'pq0-input-type', 'pq0-float-div', 'pq-bool-int', 'pq-intdiv', 'pq-floor-neg', 'pq-float-eq', 'pq-round-half', 'pq-str-mult'] },
      ...
      { key: 'py3', name: 'Making decisions',
        ...
        steps: [
          ...
          { t: 'quiz', title: 'Which branch runs?', ids: ['pq0-if-elif', 'pq0-empty-falsy', 'pq0-equals', 'pq-truthy', 'pq-or-default', 'pq-none-eq', 'pq-chained-compare'] },
      ...
      { key: 'py4', name: 'Doing it again: loops',
        ...
        steps: [
          ...
          { t: 'quiz', title: 'How many times does it run?', ids: ['pq0-indent-block', 'pq0-augmented', 'pq0-range-end', 'pq0-while', 'pq-range-lazy', 'pq4-nested-loop-count', 'pq4-enumerate-unpack', 'pq4-any-empty', 'pq-break-else', 'pq-string-concat-loop'] },
      ...
      { key: 'py5', name: 'Lists',
        ...
        steps: [
          ...
          { t: 'quiz', title: 'Indexes, copies and sorting', ids: ['pq0-index-zero', 'pq0-len-vs-index', 'pq0-list-append', 'pq-sort-return', 'pq-list-alias', 'pq-copy-slice', 'pq-slice-step', 'pq4-list-index-slice', 'pq4-list-extend-str', 'pq4-sort-mixed', 'pq4-int-str-sort', 'pq-list-copy', 'pq-nested-copy', 'pq-list-remove-loop', 'pq-extend-append', 'pq-multiline-list', 'pq-int-cache', 'pq-sorted-key', 'pq-sort-tuple', 'pq-sort-stable', 'pq-max-key', 'pq-min-empty', 'pq-str-compare'] },
      ...
      { key: 'py6', name: 'Text',
        ...
        steps: [
          ...
          { t: 'quiz', title: 'What does the string do?', ids: ['pq0-string-index', 'pq-string-immutable', 'pq-join-type', 'pq-split-empty', 'pq-slice-oob', 'pq-fstring-fmt', 'pq4-strip-vs-replace', 'pq4-title-case', 'pq4-in-vs-find', 'pq4-string-compare-case', 'pq-string-format-dict', 'pq-strip-chars'] },
      ...
      { key: 'py7', name: 'Dictionaries, sets and tuples',
        ...
        steps: [
          ...
          { t: 'quiz', title: 'Keys, order and membership', ids: ['pq0-dict-access', 'pq-dict-get', 'pq-dict-order', 'pq-set-dedupe', 'pq-set-literal', 'pq-in-dict', 'pq-string-in-list', 'pq4-dict-update-order', 'pq4-set-ops', 'pq4-counter-order', 'pq-dict-dup-key', 'pq-tuple-immutable', 'pq-dict-copy', 'pq-tuple-mutable-inside', 'pq-set-order'] },
      ...
      { key: 'py8', name: 'Functions',
        ...
        steps: [
          ...
          { t: 'quiz', title: 'Arguments, returns and scope', ids: ['pq0-print-return', 'pq0-function-args', 'pq-return-none', 'pq-scope', 'pq-args-mutable', 'pq-mutable-default', 'pq4-default-none', 'pq4-tuple-unpack', 'pq4-nested-function', 'pq4-recursion-base', 'pq-lambda-late', 'pq-args-count'] },
      ...
      { key: 'py9', name: 'When things go wrong',
        ...
        steps: [
          ...
          { t: 'quiz', title: 'Which error, and when?', ids: ['pq-except-order', 'pq-index-error', 'pq-finally', 'pq-mutable-key', 'pq4-try-else', 'pq4-raise-custom'] },
