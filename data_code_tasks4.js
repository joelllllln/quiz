...
(function () {
  ...
  T.push(
    ...
    { key: 'pipegrid', group: '33 · Tuning', title: 'Tune straight through a pipeline',
    ...
    { key: 'histgb', group: '32 · Fitting models', title: 'Boosting with early stopping',
    ...
    { key: 'calib', group: '34 · Evaluating', title: 'Check and fix probability calibration',
    ...
    { key: 'lcurve', group: '33 · Tuning', title: 'Learning curve: is more data worth it?',
    ...
    { key: 'silhouette', group: '35 · Unsupervised', title: 'Choose k with the silhouette score',
    ...
    { key: 'permimp', group: '34 · Evaluating', title: 'Permutation importance',
    ...
    { key: 'ridge', group: '32 · Fitting models', title: 'Regularised regression: tune alpha',
    ...
    { key: 'nestedcv', group: '34 · Evaluating', title: 'Nested cross-validation',
