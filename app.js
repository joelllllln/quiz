...
(function () {
  ...
  var TOPICS = [
    ...
    { key: 'logreg', no: '02', name: 'Logistic Regression', desc: 'Turn a weighted score into an honest probability.',
      levels: [{ qk: 'logreg1', part: 'Part I', name: 'Foundations' }, { qk: 'logreg2', part: 'Part II', name: 'Practice' }] },
    { key: 'bayes', no: '03', name: 'Naive Bayes', desc: 'Multiply the evidence, respect the base rate.',
      levels: [{ qk: 'bayes1', part: 'Part I', name: 'Foundations' }, { qk: 'bayes2', part: 'Part II', name: 'Practice' }] },
    { key: 'trees', no: '04', name: 'Decision Trees', desc: 'Ask the best yes/no questions, one after another.',
      levels: [{ qk: 'trees1', part: 'Part I', name: 'Foundations' }, { qk: 'trees2', part: 'Part II', name: 'Practice' }] },
